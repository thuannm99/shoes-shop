      ...
      <!-- end-menu -->
        ...
        %>
          ...
          <div style="margin-left: 50px;">
              <div>
                  ...
                  <span><i class="fa fa-chevron-right" aria-hidden="true"></i>Nhân viên</span>
              </div>
          </div>
        <br><br>
        <h1>Danh sách các nhân viên hiện tại của cửa hàng</h1>
          ...
          <div class="func" style="text-align: center">
              <a href="AddProduct.jsp"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;">Thêm nhân viên</button></a>
          </div>
          <br>
        <div class="cen">
            ...
            <tr>
                ...
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Email</th>
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Số điện thoại</th>
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Lựa chọn</th>
            </tr>
            <c:forEach items = "${emp}" var= "em">
            <tr>
                <td style="border: 1px solid #ddd;padding: 8px;">${em.id}</td>
                <td style="border: 1px solid #ddd;padding: 8px;">${em.name}</td>
                <td style="border: 1px solid #ddd;padding: 8px;">${em.email}</td>
                <td style="border: 1px solid #ddd;padding: 8px;">${em.phoneNumber}</td>
                <td>
                    <a href="/ShoeShop/user/employee/ViewUser2.jsp?id=${em.id}"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;">Chi tiết</button></a>
                    <a href="/ShoeShop/user/employee/ViewUser2.jsp?id=${em.id}"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;">Xóa</button></a>
                </td>
            </tr>
            </c:forEach>
            </table>
