...
<div style="margin-left: 50px;">
    <div>
        ...
        <span><i class="fa fa-chevron-right" aria-hidden="true"></i>Thêm số lượng</span>
    </div>
</div>
<br><br>
<!-- Text input-->
<div style="margin-left: 150px;">
    ...
    <div>
        <label>Size 36: </label>
        <input name="product_id" placeholder="Số lượng" required="" type="number" max="100" min="0" style="width: 10%;padding: 5px"><br>
        <label>Size 37: </label>
        <input name="product_id" placeholder="Số lượng" required="" type="number" max="100" min="0" style="width: 10%;padding: 5px"><br>
        <label>Size 38: </label>
        <input name="product_id" placeholder="Số lượng" required="" type="number" max="100" min="0" style="width: 10%;padding: 5px"><br>
    ...
    <br>
    <div class="col">
        <a href="ListProduct.jsp"><button style="background-color:black; color: white; border: solid 1px #ccc; border-radius: 5px; height: 40px; width: 80px;" onclick="alert('Thêm sản phẩm thành công!')">Xác nhận</button></a>
    </div>
</div>
