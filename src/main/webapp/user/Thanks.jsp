...
<html lang="vi">
    ...
    <body>
        ...
        <!-- end-menu -->
        <br> <br>
        <a href="/ShoeShop/home.jsp" style="font-size: 20px;color: blue;margin-left: 100px;">
            Quay lại trang chủ
        </a>
        <br><br>
        <h3 style="margin-left: 100px;"> 
            Cảm ơn quý khách đã đặt hàng trên trang web chúng tôi! 
        </h3>
        <h3 style="margin-left: 50px;">
            Thông tin chi tiết của đơn hàng đã được thông báo qua email của quý khách!
        </h3>
