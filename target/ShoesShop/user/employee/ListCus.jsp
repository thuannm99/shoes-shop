        ...
        %>
          ...
          <div style="margin-left: 50px;">
              <div>
                  ...
                  <span><i class="fa fa-chevron-right" aria-hidden="true"></i>Khách hàng</span>
              </div>
          </div>
        <h1>Danh sách các khách hàng hiện tại của cửa hàng</h1>
        <br><br>
    <div class="cen">
        <table style="font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 95%;margin:  0px 32px;">
            <tr>
                ...
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Phone Number</th>
                <th style="border: 1px solid #ddd;padding: 8px; background-color: #4CAF50; color: white;">Option</th>
            </tr>
            <c:forEach items ="${users}" var="user">
                <tr>
                    ...
                    <th style="border: 1px solid #ddd;padding: 8px;">
                        <a href="ViewUser2.jsp?id=${user.id}"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;">Detail</button></a>
                    </th>
                </tr>
            </c:forEach>
        </table>
