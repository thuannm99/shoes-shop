...
<body>
    ...
    <div style="margin-left: 50px;">
        <div>
            ...
            <span><i class="fa fa-chevron-right" aria-hidden="true"></i>Sản phẩm</span>
        </div>
    </div>
        <br><br>
        <h1 style="text-align: center;">Danh sách các sản phẩm hiện có tại cửa hàng</h1>
        <br>
        <div class="func" style="text-align: center">
            <a href="AddProduct.jsp"><button style="background-color: white; border: solid 1px #ccc; border-radius: 5px;">Thêm sản phẩm</button></a>
        </div>
        <br>
        <div class="cen">
            <table style="font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 95%;margin:  0px 50px;">
            <tr>
