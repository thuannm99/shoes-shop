    ...
    <body>
        ...
        <div style="margin-left: 50px;">
            <div>
                ...
                <i class="fa fa-chevron-right" aria-hidden="true"></i><a href="ListBill.jsp"> Hóa đơn </a>
                <span><i class="fa fa-chevron-right" aria-hidden="true"></i> Chi tiết hóa đơn</span>
            </div>
        </div>
        <br><br>
        <c:choose>
            <c:when test="${param.id=='1'}">
                <div>
                    <div style="width:60%; float:left;">
                        <div>
                            ...
                            <div style="width:30%; float:left; margin-left: 100px;">
                                <img src="https://res.cloudinary.com/hoangghiepp1302/image/upload/v1568878463/shoes%20shop/eqt_white_1_uptk16_aedlm5.jpg" style="width: 200px;">
                            </div>
                            <div class="width:70%; float:right; margin-left: 50px;">
                                <label style="font-weight: bold;"> Tên sản phẩm: </label> <span style="font-size: larger">EQT Bask White Blue</span><br>
                                <label style="font-weight: bold;"> Size: </label> <span style="font-size: larger">42</span><br>
                    ...
                    <div style="width:35%; float:right;">
                        <div>
                            ...
                            <div>
                                <label style="font-weight: bold;">Họ và tên: </label> <span style="font-size: larger">user2</span><br>
                                <label style="font-weight: bold;">Email: </label> <span style="font-size: larger">user2@gmail.com</span><br>
                                <label style="font-weight: bold;">Số điện thoại: </label> <span style="font-size: larger">0123412345</span><br>
                                <label style="font-weight: bold;">Địa chỉ: </label> <span style="font-size: larger">Số 10, Chi Lăng, HD</span><br>
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    <div style="margin-left: 375px;">
                        <label> -----------------------</label><br>
                        <label style="font-weight: bold;"> Tổng tiền: </label> <span style="font-size: larger">925000 VNĐ</span> <br>
                        <label style="font-weight: bold;"> Ngày đặt đơn: </label> <span style="font-size: larger">07/06/2021</span> <br>
                        <label style="font-weight: bold;"> Tình trạng: </label>
                        <select id="status" name="shoes" style="padding: 5px">
                            <option value="success" selected>Duyệt đơn</option>
                            <option value="fail">Hủy đơn</option>
                            <option value="wait">Chờ xác nhận</option>
                        </select>
                        <a href="listBil.jsp"><button style="background-color:black; color: white; border: solid 1px #ccc; border-radius: 5px; height: 40px; width: 80px;" onclick="alert('Cập nhật thông tin thành công!')">Update</button></a>
                    </div>
                </div>
            </c:when>
            <c:when test="${param.id=='2'}">
                <div>
                    <div style="width:60%; float:left;">
                        <div>
                            <h3 style="text-align: center;">Nội dung đơn hàng</h3><br>
                            <div style="width:30%; float:left; margin-left: 100px;">
                                <img src="https://res.cloudinary.com/hoangghiepp1302/image/upload/v1568878547/shoes%20shop/vans_check_1_f8i2m8_vaunod.jpg" style="width: 200px;">
                            </div>
                            <div class="width:70%; float:right; margin-left: 50px;">
                                <label style="font-weight: bold;"> Tên sản phẩm: </label> <span style="font-size: larger">Vans Checkerboard</span><br>
                                <label style="font-weight: bold;"> Size: </label> <span style="font-size: larger">42</span><br>
                                <label style="font-weight: bold;"> Số lượng: </label> <span style="font-size: larger">1</span><br>
                            </div>
                        </div>
                ...
                <div>
                    <div style="margin-left: 375px;">
                        <label> -----------------------</label><br>
                        <label style="font-weight: bold;"> Tổng tiền: </label> <span style="font-size: larger">754000 VNĐ</span> <br>
                        <label style="font-weight: bold;"> Ngày đặt đơn: </label> <span style="font-size: larger">07/06/2021</span> <br>
                        <label style="font-weight: bold;"> Tình trạng: </label>
                        <select id="status" name="shoes" style="padding: 5px;">
                            <option value="success">Duyệt đơn</option>
                            <option value="fail">Hủy đơn</option>
                            <option value="wait" selected>Chờ xác nhận</option>
                        </select>
                        <a href="listBil.jsp"><button style="background-color:black; color: white; border: solid 1px #ccc; border-radius: 5px; height: 40px; width: 80px;" onclick="alert('Cập nhật thông tin thành công!')">Update</button></a>
                    </div>
                </div>
            ...
            <c:when test="${param.id=='3'}">
                <div>
                    ...
                    <div style="width:35%; float:right;">
                        <div>
                            <h3>Thông tin nhận hàng</h3><br>
                            <div>
                                <label style="font-weight: bold;">Họ và tên: </label> <span style="font-size: larger">user3</span><br>
                                <label style="font-weight: bold;">Email: </label> <span style="font-size: larger">hieunguyetky@gmail.com</span><br>
                                <label style="font-weight: bold;">Số điện thoại: </label> <span style="font-size: larger">0323475666</span><br>
                                <label style="font-weight: bold;">Địa chỉ: </label> <span style="font-size: larger">Số 3, Bạch Mai, Hà Nội</span><br>
                            </div>
                        </div>
                    </div>
                </div>
                <div>
                    <div style="margin-left: 375px;">
                        <label> -----------------------</label><br>
                        <label style="font-weight: bold;"> Tổng tiền: </label> <span style="font-size: larger">794750 VNĐ</span> <br>
