...
<body>
    ...
    <div style="margin-left: 50px;">
        <div>
            ...
            <span><i class="fa fa-chevron-right" aria-hidden="true"></i>Thêm sản phẩm</span>
        </div>
    </div>
    <br><br>
    <div style="margin-left: 150px;">
        ...
        <div>
            ...
            <div><input id="name" name="product_id" placeholder="Tên sản phẩm" required="" type="text" style="width: 60%; padding: 5px"></div>
        ...
        <div>
            ...
            <input id="price" name="product_id" placeholder="Giá sản phẩm" required="" type="text" style="width: 20%; padding: 5px"> <span>VNĐ</span>
        </div>
        <br>
        <!-- Text input-->
        <div>
            <label>Giảm giá: </label>
            <input id="discount" name="product_id" placeholder="" required="" type="text" style="width: 10%;padding: 5px"> <span>%</span>
        </div>
        <br>
        <!-- Textarea -->
        <div>
            ...
            <div>
                <textarea id="description" name="product_description" style="height: 150px; width: 60%; padding: 5px"></textarea>
            </div>
        </div>
        ...
        <div>
            ...
            <div><input id="brand" name="product_id" placeholder="Nhãn hiệu" required="" type="text" style="width:60%; padding: 5px"></div>
        </div>
        <br>
        <!-- File Button -->
        <div class="form-group">
            <label for="filebutton">Ảnh minh họa 1: </label>
            <input id="img1" name="filebutton" class="input-file" type="file">
        </div>

        <!-- File Button -->
        <div class="form-group">
            <label for="filebutton">Ảnh minh họa 2: </label>
            <input id="img2" name="filebutton" class="input-file" type="file">
        </div>
        <br>
        <div class="col">
            <a href="AddProduct2.jsp?id=45"><button style="background-color:black; color: white; border: solid 1px #ccc; border-radius: 5px; height: 40px; width: 80px;">Tiếp tục</button></a>
        </div>
    </div>
